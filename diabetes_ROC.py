...
roc_curve_data.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_ROC_data.csv')
...
for i in range(REPS):
	...
	#feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_RF_feature_importance.csv')
	if i == 0:
		feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_RF_feature_importance.csv')
	else:
		feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_RF_feature_importance.csv',mode='a',header=False)
	...
	merged.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_ROC_data.csv',mode='a',header=False)
	...
	feature_importances_df = feature_importances_df.sort_values(by='importance', ascending=False)
	feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_eRF_feature_importance.csv')
...
plt.title('Receiver Operating Characteristic (ROC) Curve for diabetes Status')
...
accuracy_results.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/diabetes_prediction_accuracies.csv')