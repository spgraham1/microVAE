...
data = pd.read_csv('/Users/graha880/Desktop/mbVAE_resources/predictions/bmi_counts.csv',sep=',')
meta = pd.read_csv('/Users/graha880/Desktop/mbVAE_resources/predictions/bmi_metadata.csv',sep=',')
combined = pd.concat([meta,data],axis=1)
combined = combined.dropna() #remove observations with NA for BMI status
...
roc_curve_data.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/BMI_ROC_data.csv')
...
for i in range(REPS):
	...
	rf_roc_df = pd.DataFrame({'fpr': fpr, 'tpr': tpr, 'thresholds': thresholds, 'auc': auc_list, 'model': model_list, 'rep': rep_list})
	rf_importances = rf.feature_importances_
	feature_importances_df = pd.DataFrame({'feature': data.columns, 'importance': rf_importances})
	feature_importances_df = feature_importances_df.sort_values(by='importance', ascending=False)
	if i == 0:
		feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/bmi_RF_feature_importance.csv')
	else:
		feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/bmi_RF_feature_importance.csv',mode='a',header=False)
	...
	merged.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/BMI_ROC_data.csv',mode='a',header=False)
	...
	feature_importances_df = feature_importances_df.sort_values(by='importance', ascending=False)
	feature_importances_df.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/bmi_eRF_feature_importance.csv')
...
plt.title('Receiver Operating Characteristic (ROC) Curve for BMI Status')
...
accuracy_results.to_csv('/Users/graha880/Desktop/mbVAE_resources/full_vs_subsample/softplus_models/predictions/BMI_prediction_accuracies.csv')