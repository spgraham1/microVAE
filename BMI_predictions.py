...
mapping_strategies = [overweight_vs_not, normal_vs_all, collapsed_categories, all_classes_mapping]
...
for myMap in mapping_strategies:
   ...
   # iterate through the classes and select minCount random samples from each class
	...
	for i in range(100):
		...
		mlp = MLPClassifier(random_state=12,hidden_layer_sizes=(800, 200), activation='relu', solver='adam',max_iter=10000)
		...
		for infile in models:
			...
			embeddedMLP = MLPClassifier(random_state=12,hidden_layer_sizes=(10,5),activation='relu',solver='adam',max_iter=10000)
...
accuracy_results.to_csv('/Users/graha880/Desktop/mbVAE_resources/predictions/BMI_prediction_accuracies.csv')